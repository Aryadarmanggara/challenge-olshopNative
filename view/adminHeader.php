...
<html>
  <head>
    <title>BlanjaMurmer | Belanja Murah Meriah</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="author" content="AryaDarmaAnggara">
          ...
          <div class="col-lg-8 col-md-6 col-sm-5 py-2 pembatas">
            ...
            <ul class="nav">
              <li class="nav-item text-white">
                <a class="nav-link"><i class="fa fa-envelope-o"></i>&nbsp;<span class="size-mail">contact@blanjamurmer.com</span></a>
              </li>
              <li class="nav-item text-white">
                <a class="nav-link"><i class="fa fa-instagram"></i>&nbsp;<span class="size-mail">BlanjaMurmer</span></a>
              </li>
              <li class="nav-item text-white">
                <a class="nav-link"><i class="fa fa-facebook"></i>&nbsp;<span class="size-mail">BlanjaMurmer</span></a>
              </li>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
              <!-- <li class="nav-item">
                <a class="nav-link text-uppercase" href="admin.php">Home </a>
              </li> -->
            </ul>
